  ...
  return (
          <div className="relative inline-block mb-8">
            <div className="relative w-32 h-32 mx-auto">
              <div className="absolute inset-0 bg-gradient-to-br from-[#305CDE] via-[#4F75FF] to-[#6B8AFF] rounded-full animate-blob opacity-90"></div>
              <div className="absolute inset-2 bg-gradient-to-tr from-[#4F75FF] via-[#305CDE] to-[#8BA5FF] rounded-full animate-blob-reverse opacity-70"></div>
